...
const MOCK_USERS = [
  { id: "1", nome: "Manuel Teste", email: "alexandre.matos@empresa.com", cargo: "Analista Sénior", departamento: "Tecnologia", status: "Ativo", tipo: "Interno", dataCriacao: "12/01/2024", ultimoAcesso: "Hoje, 10:45", telefone: "+244 923 000 111", unidade: "Sede Luanda", avatar: "" },
  { id: "2", nome: "Manuel Teste", email: "silva@empresa.com", cargo: "Gerente de Projecto", departamento: "Comercial", status: "Inativo", tipo: "Interno", dataCriacao: "05/11/2023", ultimoAcesso: "Ontem, 17:20", telefone: "+244 923 000 222", unidade: "Benguela", avatar: "" },
  { id: "3", nome: "Manuel Teste", email: "pinto@externo.com", cargo: "Consultor Externo", departamento: "Operações", status: "Bloqueado", tipo: "Externo", dataCriacao: "20/12/2023", ultimoAcesso: "15/01/2024", telefone: "+244 923 000 333", unidade: "Sede Luanda", avatar: "" },
  { id: "4", nome: "Manuel Teste", email: "silva@empresa.com", cargo: "Coordenador", departamento: "Recursos Humanos", status: "Ativo", tipo: "Admin", dataCriacao: "02/02/2024", ultimoAcesso: "Hoje, 09:00", telefone: "+244 923 000 444", unidade: "Huambo", avatar: "" },
];
